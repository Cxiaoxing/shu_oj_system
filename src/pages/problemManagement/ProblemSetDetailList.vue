<template>
  <div>
    ...
    <el-card style="margin-top: 20px">
      ...
      <el-row :gutter="40">
        <el-col :span="8">
          <el-input
            ...
            v-model="searchInput"
            @keyup.enter.native="getProblemSetDetailList()"
          >
      ...
      <!-- 列表区域 -->
      <el-table :data="problemSetDetailList" style="margin-top: 20px">
        ...
        <el-table-column label="操作">
          <template slot-scope="scope">
            ...
            <el-button
              size="small"
              @click="
                goProblemDetail(scope.row.out_problem.id, scope.row.region)
              "
              >查看</el-button
            >
            <!-- 删除按钮 -->
      ...
      <el-pagination
        background
        hide-on-single-page
        @current-change="getProblemSetDetailList"
        :page-size="pageSize"
        ...
        >
          <template slot-scope="scope">
            ...
            <el-tag
              effect="dark"
              type="danger"
              v-if="scope.row.info.difficulty == 3"
              >困难
            </el-tag>
          </template>
        </el-table-column>
