...
export default {
  ...
  created() {
      // this.name = window.localStorage.getItem('liveName');
  },

  methods: {
    playerHandler() {
      this.$router.push("/playerLive");
    },
  },
};
</script>
